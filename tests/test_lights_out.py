...
class TestLightsOutGame:
    ...
    def test_validate_move_success(self):
        ...
        success, message = game.validate_move(3, 3)
    ...
    def test_validate_move_invalid_coordinates(self):
        ...
        # Out of bounds
        success, message = game.validate_move(0, 0)
        assert success is False
        assert "Invalid coordinates" in message

        success, message = game.validate_move(6, 6)
        assert success is False
        assert "Invalid coordinates" in message

    def test_is_complete_all_off(self):
    ...
    def test_is_complete_lights_on(self):
    ...
    def test_moves_counter(self):
        ...
        game.validate_move(3, 3)
        assert game.moves_made == initial_moves + 1

        game.validate_move(2, 2)
    ...
    def test_puzzle_generation_creates_initial_state(self):
    ...
    def test_edge_cells_have_fewer_neighbors(self):
